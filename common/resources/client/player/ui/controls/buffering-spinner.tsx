...
export function BufferingSpinner({
  ...
  const isActive = usePlayerStore(s => {
    // todo: firing with progress event for some reason
    //console.log(s.isBuffering, s.playbackStarted, s.providerReady);
    return s.isBuffering || (s.playbackStarted && !s.providerReady);
  });
  return (
